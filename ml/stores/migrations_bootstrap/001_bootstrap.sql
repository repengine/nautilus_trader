...
-- MBP-10/MBO are excluded from this view because they store depth/order payloads
-- as JSON (lossy to coerce into L1 fields). Query market_data_mbp10 or
-- market_data_mbo directly when depth/order book detail is required.

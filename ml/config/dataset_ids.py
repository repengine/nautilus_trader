...
EQUS_MINI_MBP10_DATASET_ID: Final[str] = "EQUS.MINI_MBP10"
"""Dataset identifier for Databento EQUS MBP-10 data."""

EQUS_MINI_MBO_DATASET_ID: Final[str] = "EQUS.MINI_MBO"
"""Dataset identifier for Databento EQUS MBO data."""

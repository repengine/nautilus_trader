...
class SignalPolicySwapper:
    ...
    def __init__(self) -> None:
        ...
        All swap preparation happens off hot path.
        Reading current_strategy is single attribute dereference.
...
class SignalStrategyComponent:
    ...
    def _create_builtin_strategy(
        ...
        strat_config = config.strategy_config if hasattr(config, "strategy_config") and config.strategy_config else None
        ...
        def _mk_ensemble() -> SignalGenerationStrategy:
            ...
            weights = strat_config.ensemble_weights if strat_config and strat_config.ensemble_weights else {
                "threshold": 0.4,
                "extremes": 0.3,
                "momentum": 0.3,
            }

...
class TestOnnxLoading:
    ...
    def test_onnx_loading_creates_inference_session(
        ...
        with patch("ml.actors.components.model_warmup.HAS_ONNX", True):
            with patch("ml.actors.components.model_warmup.ort") as mock_ort:
    ...
    def test_onnx_loading_raises_if_onnx_not_available(
        ...
        with patch("ml.actors.components.model_warmup.HAS_ONNX", False):
            with patch("ml.actors.components.model_warmup.check_ml_dependencies") as mock_check:

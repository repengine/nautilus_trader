...
We validate basic behavior of ThresholdSignalStrategy to ensure that hot-path logic
produces an MLSignal when the confidence threshold is met, and returns None otherwise.

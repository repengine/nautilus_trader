...
class TestEdgarFetcher:
    ...
    def test_fetch_earnings_success(self) -> None:
    ...
    def test_fetch_earnings_no_filings(self) -> None:
    ...
    def test_fetch_earnings_missing_xbrl(self) -> None:
    ...
    def test_fetch_earnings_multiple_quarters(self) -> None:

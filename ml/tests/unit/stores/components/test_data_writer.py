...
from ml.stores.components.data_writer import DataEvent, DataWriterComponent
from ml.stores.components.schema_validator import QualityReport, ValidationViolation
...
@patch("ml.stores.components.data_writer.HAS_PROMETHEUS", True)
@patch("ml.stores.components.data_writer.write_rejection_counter")

...
This test suite provides comprehensive coverage for the MLflowXGBoostTracker, including
MLflow integration, experiment tracking, model registry operations, and artifact
...
class TestMLflowXGBoostTracker:
    ...
    def test_log_metadata(self, mock_mlflow, basic_config) -> None:
        ...
        assert (
            mock_mlflow.set_tag.call_count >= 4
        )  # At least n_features, timestamp, top_feature, importance_sum

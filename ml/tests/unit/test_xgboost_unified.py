...
This test suite provides comprehensive coverage for the UnifiedXGBoostTrainer, including
GPU configuration, feature decay tracking, hyperparameter optimization, MLflow
integration, and model export functionality.
...
class TestUnifiedXGBoostTrainer:
    ...
    def test_onnx_export_path_creation(self, basic_config) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                patch("ml.training.xgboost_unified.check_ml_dependencies") as mock_check_deps,

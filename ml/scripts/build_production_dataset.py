...
Usage:
    python ml/scripts/build_production_dataset.py --phase 1  # Historical L0/L1
    python ml/scripts/build_production_dataset.py --phase 2  # Microstructure
    python ml/scripts/build_production_dataset.py --phase 3  # Cross-sectional
    python ml/scripts/build_production_dataset.py --full     # Complete pipeline

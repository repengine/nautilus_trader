...
```bash
# Basic usage
python ml/scripts/run_ml_pipeline.py --mode daily

# With custom configuration
python ml/scripts/run_ml_pipeline.py --mode daily --config ml/config/pipeline_config.yaml

# Dry run (no actual data collection)
python ml/scripts/run_ml_pipeline.py --mode daily --dry-run

# Verbose logging
python ml/scripts/run_ml_pipeline.py --mode daily --verbose
```
...
python ml/scripts/run_ml_pipeline.py --mode realtime

# Test real-time setup
python ml/scripts/run_ml_pipeline.py --mode realtime --dry-run
```
...
ExecStart=/usr/bin/python3 /path/to/ml/scripts/run_ml_pipeline.py --mode daily --config /path/to/config.yaml
...
0 4 * * * cd /path/to/nautilus_trader && python3 ml/scripts/run_ml_pipeline.py --mode daily --config config.yaml >> /var/log/ml_pipeline.log 2>&1
```
...
# Run pipeline
CMD ["python", "ml/scripts/run_ml_pipeline.py", "--mode", "daily"]
```
...
```bash
python ml/scripts/run_ml_pipeline.py --mode daily --verbose --dry-run
```

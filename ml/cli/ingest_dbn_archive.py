...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.catalog_path:
        ...
        if os.environ.get("CATALOG_REHYDRATE_DATASET_TYPE_TEMPLATES"):
            logger.warning(
                "Ignoring deprecated dataset type identifier templates for catalog writes",
                extra={"env": "CATALOG_REHYDRATE_DATASET_TYPE_TEMPLATES"},
            )

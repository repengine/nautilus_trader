...
"""
Legacy Data registry implementation (preserved for feature flag fallback).
...
This is the original god class implementation (1,819 lines) preserved for backwards
compatibility via the ML_USE_LEGACY_DATA_REGISTRY feature flag.
...
class DataRegistryLegacy(MLComponentMixin):
    """
    Legacy implementation of DataRegistry (preserved for feature flag).

...
_DATASET_TYPE_DEFAULTS: dict[DatasetType, DatasetManifestSpec] = {
    ...
    DatasetType.RISK_HALT_EVENTS: DatasetManifestSpec(
        schema={
            "event_id": "str",
            "strategy_id": "str",
            "instrument_id": "str",
        ...
        primary_keys=("event_id",),
        retention_days=365,
        metadata={"schema_kind": "risk_halt_events"},
    ),
    DatasetType.REPLAY_SUMMARY: DatasetManifestSpec(
        schema={
            "run_id": "str",
            "instrument_ids": "json",
            "started_ns": "int64",
        ...
        primary_keys=("run_id",),
        retention_days=365,
        metadata={"schema_kind": "replay_summary"},
    ),

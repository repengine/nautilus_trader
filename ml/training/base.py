...
class BaseMLTrainer(ABC):
    ...
    def _create_model_manifest(self, save_path: Path) -> ModelManifest:
        ...
        if self._feature_names:
            ...
            feature_dtypes = getattr(self._config, "feature_dtypes", ["float32"] * len(self._feature_names))
        ...
        serveable = save_path.suffix.lower() == ".onnx" or getattr(self._config, "export_onnx", False)
        ...
        return ModelManifest(
            ...
            architecture=self.__class__.__name__.replace("Trainer", ""),  # e.g., "XGBoostTrainer" -> "XGBoost"

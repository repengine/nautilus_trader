...
Environment Variables:
    ML_USE_LEGACY_PIPELINE_ORCHESTRATOR: Set to "1" to use legacy orchestrator,
...
Examples:
    ...
    >>> os.environ.pop("ML_USE_LEGACY_PIPELINE_ORCHESTRATOR", None)
    >>> assert use_legacy_orchestrator() is False
...
def use_legacy_orchestrator() -> bool:
    ...
    Returns:
        True if ML_USE_LEGACY_PIPELINE_ORCHESTRATOR or ML_USE_LEGACY_ORCHESTRATOR
        is set to "true", "1", or "yes" (case-insensitive), False otherwise
        (default: new facade)

    Note:
        Default is False (facade mode), enabling safe gradual rollout.
        Set ML_USE_LEGACY_PIPELINE_ORCHESTRATOR to "true", "1", or "yes" to
    ...
    Example:
        ...
        >>> os.environ["ML_USE_LEGACY_PIPELINE_ORCHESTRATOR"] = "1"
        >>> assert use_legacy_orchestrator() is True
        >>> os.environ["ML_USE_LEGACY_PIPELINE_ORCHESTRATOR"] = "true"
        >>> assert use_legacy_orchestrator() is True
        >>> os.environ["ML_USE_LEGACY_PIPELINE_ORCHESTRATOR"] = "yes"
        >>> assert use_legacy_orchestrator() is True
        >>> os.environ["ML_USE_LEGACY_PIPELINE_ORCHESTRATOR"] = "0"
        >>> assert use_legacy_orchestrator() is False
        >>> os.environ.pop("ML_USE_LEGACY_PIPELINE_ORCHESTRATOR", None)
    ...
    """
    value = (
        os.getenv("ML_USE_LEGACY_ORCHESTRATOR")
        or os.getenv("ML_USE_LEGACY_PIPELINE_ORCHESTRATOR")
        or "false"
    ).lower()

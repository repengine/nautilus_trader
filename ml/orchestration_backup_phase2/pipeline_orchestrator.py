...
if not _use_component_impl():
    ...
    class _CompatibleLegacyOrchestrator(_legacy.MLPipelineOrchestrator):
        ...
        def compute_window_start_iso(
            ...
            """
            Legacy-compatible helper mirroring the component facade API.
            """
        ...
        def get_health_status(self) -> dict[str, str]:
            """
            Provide a lightweight health snapshot for parity tests.
            """
            def _status(component: object) -> str:
                return "healthy" if component is not None else "uninitialized"

            return {
                "implementation": "legacy",
                "config_resolver": _status(self._config_resolver),
                "discovery_client": _status(self._discovery_client),
                "binding_resolver": _status(self._binding_resolver),
                "ingestion_coordinator": _status(self._ingestion_coordinator),
                "dataset_builder": _status(self._dataset_builder),
            }

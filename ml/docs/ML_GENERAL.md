...
If you share **one specific instrument + intended decision horizon** (e.g., “trade ES at 1–3s horizon” or “trade EURUSD at 10–60s”), I’ll sketch the **exact teacher labels, student features**, and **first pass LightGBM config**, plus the **Prometheus counters** and **two UI widgets** needed to run it end‑to‑end this week.

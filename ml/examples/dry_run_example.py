...
def setup_backtest_engine(configs: dict):
    """
    ...
    engine_config = BacktestEngineConfig(
        ...
        strict_position_interactions=False,
    )
...
def run_dry_run_backtest():
    ...
    print(f"- Strategy Mode: DRY RUN (execute_trades=False)")
    print(f"- Using Dummy Stores: True")
    ...
    bars = provider.generate_bar_data(
